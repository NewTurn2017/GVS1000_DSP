package com.gvkorea.gvs1000_dsp.fragment.tune.fragment.evaluation.audio
...
import com.gvkorea.gvs1000_dsp.fragment.tune.fragment.evaluation.EvalFragment.Companion.isStarted
...
class RecordAudioRta(val view: View) :
    ...
    private val calib_data =
            CSVRead(view.context).readCalibCsv(view.context.assets, MainActivity.selectedMicName)
